...
<div class="container mt-4 text-center pt-4 calcMain">
    ...
    <dialog open style="position: fixed; left: 0; top: 0; width: 320px; margin-left: 10px;">
        <div class="alert alert-warning" role="alert">
            <img src="images/golf-1.jpg" style="width: 50px; height: 50px; margin-left: -15px;"  alt="logo"/><span style="font-size: small; padding-left: 8px;">Subscribe to Golf-Clubs-Events channel?</span>
            <br>
